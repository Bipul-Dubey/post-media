...
import { AuthImage, TakJhakLogo } from "../../assets";
...
const Authentication: React.FC = () => {
  ...
  const handleLogin = () => {
    navigate(PATHS.NEWS_FEED);
    login();
  };

  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 text-gray-900 flex justify-center">
        ...
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 flex flex-col justify-center">
          ...
          <div className="mt-2 flex flex-col items-center">
            <div className="w-full flex-1 mt-6">
              ...
              <div className="mx-auto max-w-xs gap-4 flex flex-col">
                ...
                <div>
                  ...
                  <span className="text-blue-700 hover:cursor-pointer border-b">
                    Signup
                  </span>
                </div>
